...
describe('ObjectDelegator#getter', () => {
  it('must be work called with ("getter")', () => {
    ...
    assert.ok(object.getter('getter') instanceof ObjectDelegator);
    ...
    assert.strictEqual(target.getter, source.getter);
  ...
  it('must be work called with ("getter", #descriptor)', () => {
    ...
    assert.ok(object.getter('getter', descriptor) instanceof ObjectDelegator);
